...
const Footer = () => {
  ...
  return (
    <>
      <footer className='bg-gray-200 px-8 py-4 md:grid grid-cols-2 xl:grid-cols-6 xl:px-20'>
        {links.map(link => {
          ...
          return (
            <div key={id}>
              <div className='mb-10'>
                ...
                {hrefs.map(href => {
                  return (
                    <li key={hrefs} className='text-gray-400 text-sm my-2'>
                      {href}
                    </li>
                  );
                })}
      ...
      <div className='bg-gray-200 px-8 pb-4 md:flex items-center justify-between xl:px-20'>
        ...
        <div>
          <ul className='flex flex-wrap text-sm mt-4 text-gray-600'>
            ...
            <li className='mr-4'>&copy; by David De Castro 2021</li>
          </ul>
        </div>
      </div>
    </>
